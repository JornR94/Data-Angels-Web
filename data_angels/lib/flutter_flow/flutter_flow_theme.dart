...
abstract class FlutterFlowTheme {
  ...
  late Color darkerBlue;
  late Color darkerPurple;
  late Color lighterBlue;
...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFF4F2DFF);
  Color secondaryColor = const Color(0xFF7500FF);
  ...
  Color darkerBlue = Color(0xFF4F2DFF);
  Color darkerPurple = Color(0xFF6019FF);
  Color lighterBlue = Color(0xFF008DFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  Color darkerBlue = Color(0xFFAEF04B);
  Color darkerPurple = Color(0xFFE8BD91);
  Color lighterBlue = Color(0xFF2305FF);
}
